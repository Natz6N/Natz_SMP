...
public class NmsAdapterImpl implements NmsAdapter {
   ...
   private static final ReflectField<NetworkManager> NETWORK_MANAGER_FIELD = new ReflectField(ServerCommonPacketListenerImpl.class, "e");
   ...
   private ChannelPipeline getPipeline(Player player) {
      ...
      NetworkManager networkManager = (NetworkManager)NETWORK_MANAGER_FIELD.get(playerConnection);
